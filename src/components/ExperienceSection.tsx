...
export default function ExperienceSection({
  ...
  return (
    <div className="w-[90%] max-w-[1400px] bg-card shadow p-6 rounded-lg">
      <div className="text-heading w-full flex flex-col md:flex-row justify-between mb-4">
